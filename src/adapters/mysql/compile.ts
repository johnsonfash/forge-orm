...
// MySQL compile API — same shape as Postgres / Mongo, returns SQLArtifact with
// dialect='mysql'. Goes through the shared IR; only compileFromIR differs.
...
export function buildMysqlCompileApi(model: ModelDef<any>): SQLCompileApi {
