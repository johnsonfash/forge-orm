...
* [Connecting](#connecting)
  * [Option 1 — `url` (the default)](#option-1--url-the-default)
  * [Option 2 — a per-dialect entry point](#option-2--a-per-dialect-entry-point-new-in-2170)
  * [Option 3 — `driver` (bring your own client)](#pluggable-drivers)
...
[Connecting](#connecting) for what that choice actually decides.
