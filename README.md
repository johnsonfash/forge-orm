...
* [Browser (sqlite-wasm + OPFS)](#browser-sqlite-wasm--opfs)
  ...
  * [Worked example: React + Vite + sqlite-wasm](#worked-example-react--vite--sqlite-wasm)
  * [Worked example: Next.js App Router + sqlite-wasm](#worked-example-nextjs-app-router--sqlite-wasm)
  * [Worked example: Vue 3 + Vite + sqlite-wasm](#worked-example-vue-3--vite--sqlite-wasm)
  * [Worked example: Nuxt 3 + sqlite-wasm](#worked-example-nuxt-3--sqlite-wasm)
  * [Worked example: SvelteKit + sqlite-wasm](#worked-example-sveltekit--sqlite-wasm)
  * [Worked example: Angular + sqlite-wasm](#worked-example-angular--sqlite-wasm)
  * [Worked example: SolidStart + sqlite-wasm](#worked-example-solidstart--sqlite-wasm)
  * [Worked example: Astro + sqlite-wasm](#worked-example-astro--sqlite-wasm)
  * [Worked example: Remix + sqlite-wasm](#worked-example-remix--sqlite-wasm)
  * [Worked example: React Native + op-sqlite (bonus)](#worked-example-react-native--op-sqlite-bonus)
  * [Worked example: Tauri desktop + better-sqlite3](#worked-example-tauri-desktop--better-sqlite3)
...
### Worked example: React + Vite + sqlite-wasm
...
### Worked example: Next.js App Router + sqlite-wasm
...
### Worked example: Vue 3 + Vite + sqlite-wasm
...
### Worked example: Nuxt 3 + sqlite-wasm
...
### Worked example: SvelteKit + sqlite-wasm
...
### Worked example: Angular + sqlite-wasm
...
[Webpack/CRA setup](#webpack--cra--rsbuild-setup) section.
...
### Worked example: SolidStart + sqlite-wasm
...
### Worked example: Astro + sqlite-wasm
...
### Worked example: Remix + sqlite-wasm
...
### Worked example: React Native + op-sqlite (bonus)
